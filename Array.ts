...
//       let celsius = celsiusTemperatures[index];
...
//   const celsiusArray = [25, 30, 15, 10, 20];
//   const fahrenheitArray = convertTemperatures(celsiusArray);
  
//   console.log("Converted temperatures in Fahrenheit:", fahrenheitArray);
